<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="ChangProUser.aspx.cs" Inherits="barbushop.ChangProUser" %>
                    ...
                    <asp:DropDownList ID="DropDownListCity" class="form-control" placeholder="עיר " runat="server"></asp:DropDownList>
                                        ...
                                        <div class="form-group">
                                           <%-- <input type="text" class="form-control" placeholder="Enter Your Answer *" value="" />--%>
                                             <input type="checkbox"  id="checklog" runat="server" class="form-check-input" />
