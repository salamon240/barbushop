<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm10.aspx.cs" Inherits="barbushop.WebForm10" %>
...
<div class="container register-form" style="padding:50px;">
  ...
  <tbody style="text-align:right;">
                    ...
                    <a type="button" class="btnSubmit" href="managerPerson.aspx" style="float:right; text-align:center;">חזרה</a>
                </div>
            </div>
        </div>
