<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageEOrderInfo.aspx.cs" Inherits="barbushop.ManageEOrderInfo" %>
...
.btnSubmit
{
  ...
  <tbody style="text-align:right;">
                    ...
                    <a type="button" class="btnSubmit" href="ManagerEPrson.aspx" style="float:right; text-align:center;">חזרה</a>
                </div>
            </div>
        </div>
    </form>
