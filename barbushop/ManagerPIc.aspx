<%@ Page Title="" Language="C#" MasterPageFile="~/managerMster.Master" AutoEventWireup="true" CodeBehind="ManagerPIc.aspx.cs" Inherits="barbushop.ManagerPIc" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <section>
                 ...
                 <footer class="page-footer font-small blue" style="padding-bottom: 30px; background-color:crimson;">
          <div class="footer-copyright text-center py-3">
              <asp:Label ID="lblprodCat" runat="server" Text="" style="font-size: x-large; font-weight: bold; color:white;"></asp:Label></div>
...
<%--                 <button type="button" class="btn btn-primary btn-lg btn-block mb-3" />nlknslfnads</button>--%>
                    ...
                    <a class="add-to-cart" style="color:darkcyan; float:right;"  href="ManagerChangeProd.aspx?prodid=<%#Eval("productId")%>"> פרטים</a>
