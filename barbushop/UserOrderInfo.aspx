<%@ Page Title="" Language="C#" MasterPageFile="~/user.Master" AutoEventWireup="true" CodeBehind="UserOrderInfo.aspx.cs" Inherits="barbushop.UserOrderInfo" %>
...
.btnSubmit
{
  ...
  <tbody style="text-align:right;">
                    ...
                    <a type="button" class="btnSubmit" href="UserPreson.aspx" style="float:right; text-align:center;">חזרה</a>
                </div>
            </div>
        </div>
