<%@ Page Title="" Language="C#" MasterPageFile="~/Entery.Master" AutoEventWireup="true" CodeBehind="AddEmployees.aspx.cs" Inherits="barbushop.AddEmployees" %>
                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">הרשמה עובד חדש</h3>
...
<%--                                            <input type="text" class="form-control" placeholder="Last Name *" value="" />--%>
                            ...
                            <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="סיסמא שגוייה.." ControlToCompare="TextBox1" ControlToValidate="TextPassword" ForeColor="Red"></asp:CompareValidator>
...
<%--                                            <input type="email" class="form-control" placeholder="Your Email *" value="" />--%>
            ...
            <label class="form-check-label" for="exampleCheck1" style="margin-right 15px">אני מאשר שכל הפרטים נכונים ואני מאשר אתר <a href="termsOfUse.aspx" target="_blank">תנאי השימוש</a></label>
                                        ...
                                        <asp:Button ID="Button1" runat="server" class="btnRegister" Text="אין עובדים " OnClick="Button1_Click"  />
